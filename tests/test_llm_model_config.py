...
def test_openai_compatible_chat_handles_text_and_tools(monkeypatch):
    ...
    monkeypatch.setattr(web_handler, "_web_search", _search)
    ...
    monkeypatch.setattr(web_handler, "_web_search", _failed_search)
    ...
    habit_id, _reactivated = add_habit(1, "Walk", "daily:1")
