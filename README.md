...
有自己的心跳，会在 08:00–00:30 均匀地主动找你，也会好奇你的一切。
...
- 调整每天主动消息（Free Time）的数量，例如「每天最多主动找我 5 次」。机会会铺满 08:00–00:30，相邻至少 15 分钟，上限是这个窗口里 15 分钟一格能放下的最多次数。
...
| 主动陪伴 | 不必总等你先开口，机会在 08:00–00:30 均匀分布，次数不少于每天安排 |
