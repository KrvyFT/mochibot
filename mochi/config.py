...
# Unused by heartbeat; kept so leftover .env/DB values still seed as a no-op.
...
CORE_REFRESH_ENABLED = _env_bool("CORE_REFRESH_ENABLED", True)
CORE_REFRESH_HOURS = os.environ.get("CORE_REFRESH_HOURS", "12,23")
